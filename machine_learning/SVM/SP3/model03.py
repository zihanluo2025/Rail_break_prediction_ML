...
table_name = "`09ad024f-822f-48e4-9d9e-b5e03c1839a2`.predictive_maintenance_uofa_2025.preprocess_training_table"
df_spark = (
...
train_idx, test_idx = next(gss.split(df[feat_cols], y, groups=groups))
X_train, X_test = df.loc[train_idx, feat_cols], df.loc[test_idx, feat_cols]
...
pipe = Pipeline(steps=[
    ...
    ("svm", LinearSVC(C=3.0,dual=False, class_weight="balanced",
