...
explainer = shap.LinearExplainer(svm, X_train_s)
...
shap.summary_plot(shap_matrix, X_test, feature_names=X_test.columns, plot_type="bar")

shap.summary_plot(shap_matrix, X_test, feature_names=X_test.columns)
