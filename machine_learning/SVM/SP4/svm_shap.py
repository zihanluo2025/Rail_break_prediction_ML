...
protected = set(leak_cols + id_cols + ["Tc_target"])
...
feat_cols = [c for c in TOP_FEATURES if c in df.columns and c not in protected]
...
print(f"Use the number of features: {len(feat_cols)}")
print("The first few features:", feat_cols[:10])
