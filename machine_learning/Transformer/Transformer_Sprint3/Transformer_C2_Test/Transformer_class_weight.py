...
# MAGIC | ---: | :--- | :--- |
# MAGIC | 2025-09-10 | Di	Zhu | Initial version for competition 2 (Preprocessing total training table).|
...
class_sample_count = torch.tensor([(y_train == 0).sum(), (y_train == 1).sum()], dtype=torch.float)
weights = 1. / class_sample_count
sample_weights = torch.tensor([weights[t] for t in y_train.long()])
