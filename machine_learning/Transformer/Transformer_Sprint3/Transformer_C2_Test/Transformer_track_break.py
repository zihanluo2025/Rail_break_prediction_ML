...
# MAGIC | ---: | :--- | :--- |
# MAGIC | 2025-09-14 | Di	Zhu | competition 2 (Transformer + Track break date table).|
...
df = spark.sql("""
SELECT *
FROM `09ad024f-822f-48e4-9d9e-b5e03c1839a2`.predictive_maintenance_uofa_2025.preprocess_training_table_track_break_day
LIMIT 10000
""")
