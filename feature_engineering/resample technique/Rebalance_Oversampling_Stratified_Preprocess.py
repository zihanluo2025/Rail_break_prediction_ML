...
# MAGIC %md
# MAGIC
# MAGIC # Rebalance_Oversampling_Stratified_Preprocess
# MAGIC
...
recommended_strata_cols = ['Wagon_ICWVehicle', 'Tng_Tonnage', 'Wagon_Speed']  #recommend to select from recommended_strata_cols, multiple column are accepted
